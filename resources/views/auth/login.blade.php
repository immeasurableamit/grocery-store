...
<!-- Mirrored from coderthemes.com/upvex/layouts/light/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jan 2021 15:56:14 GMT -->
<head>
        <meta charset="utf-8" />
    ...
    <body class="authentication-bg authentication-bg-pattern">
        ...
        @endif
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.html">
                                        <span><img src="{{ asset('assets/images/logo-top-1.png') }}" alt="" height="26"></span>
                                    </a>
        ...
        <!-- Vendor js -->
        <script src="{{ asset('admin_assetsassets/js/vendor.min.js')}}"></script>

        <!-- App js -->
        <script src="{{ asset('admin_assetsassets/js/app.min.js')}}"></script>
