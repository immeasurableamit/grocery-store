...
<head>
    ...
    <!-- plugin css -->
    <link href="{{ asset('admin_assets/libs/jquery-vectormap/jquery-jvectormap-1.2.2.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ asset('admin_assets/libs/jquery-nice-select/nice-select.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('admin_assets/libs/bootstrap-select/bootstrap-select.min.css')}}" rel="stylesheet" type="text/css" />

    <!-- Dropzone css -->
    <link href="{{ asset('admin_assets/libs/dropzone/dropzone.min.css')}}" rel="stylesheet" type="text/css" />
    @toastr_css
        ...
        <div class="navbar-custom">
                ...
                <li class="dropdown notification-list">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-lg">
                        ...
                        <div class="slimscroll noti-scroll">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="notify-icon">
                                    <img src="{{ asset('admin_assets/images/users/user-4.jpg')}}" class="img-fluid rounded-circle" alt="" />
                                </div>
            ...
            <div class="logo-box">
                <a href="index.html" class="logo text-center">
                    <span class="logo-lg">
                        <img src="{{ asset('admin_assets/images/logo-light.png')}}" alt="" height="24">
                        <!-- <span class="logo-lg-text-light">Upvex</span> -->
                    </span>
                    <span class="logo-sm">
                        <!-- <span class="logo-sm-text-dark">X</span> -->
                        <img src="{{ asset('admin_assets/images/logo-sm.png')}}" alt="" height="28">
                    </span>
                </a>
            </div>
...
{{--
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="text-md-right footer-links d-none d-sm-block">
                        <a href="javascript:void(0);">Version {{ App::VERSION() }}</a>
    ...
    <div class="right-bar">
        ...
        <div class="slimscroll-menu">
            ...
            <div class="user-box">
                <div class="user-img">
                    <img src="{{ asset('admin_assets/images/users/user-1.jpg')}}" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
    ...
    <script src="{{ asset('admin_assets/libs/jquery-vectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
    <script src="{{ asset('admin_assets/libs/jquery-vectormap/jquery-jvectormap-us-merc-en.js')}}"></script>
    ...
    <script src="{{ asset('admin_assets/libs/jquery-nice-select/jquery.nice-select.min.js')}}"></script>

    <!-- Dropzone js -->
    <script src="{{ asset('admin_assets/libs/dropzone/dropzone.min.js')}}"></script>
